<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO employees (username, password, first_name, last_name, other_name, sex, status, address, occupation, company, email, salary, tax) 
		VALUES ('$username', '$password', '$first_name', '$last_name', '$other_name', '$sex', '$status', '$address', '$occupation', '$company', '$email', '$salary', '$tax')";
...
<head>
	...
	<title>E-Tax | <?php echo htmlspecialchars($_SESSION["company_name"]); ?> - Activies</title>
...
<body>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Tax </span></a>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="company.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			<li class="active"><a href="company_control.php">Activites </a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><?php echo htmlspecialchars($_SESSION["company_name"]); ?> Employees</h1>
			</div>
		</div>
						...
						<table class='table table-striped table-responsible'>
							...
							<tbody>
								<?php
									...
									<td align="center">
									<a href="company_control_delete.php?id=<?php echo $row["username"]; ?>" class="btn btn-info">Delete</a>
									</td>
									</tr>
								<?php $count++; } ?>
							</tbody>
		...
		<div class="col-md-12 col-sm-12 col-lg-12">
                <div class="panel panel-default col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="panel-body">
                        <form action="company_control.php" method="POST" class="form-horizontal">
							<div class="form-group">
								<label for="first_name" class="control-label col-sm-4">Firstname </label>
								<div class="col-md-5">
								<input type="text" class="form-control" id="first_name" name="first_name" required="required">
								</div>
							</div><div class="form-group">
								<label for="last_name" class="control-label col-sm-4">Lastname </label>
								<div class="col-md-5">
								<input type="text" class="form-control" id="last_name" name="last_name" required="required">
								</div>
							</div><div class="form-group">
								<label for="other_name" class="control-label col-sm-4">Othername </label>
								<div class="col-md-5">
								<input type="text" class="form-control" id="other_name" name="other_name" required="required">
								</div>
							</div>
							<div class="form-group">
								<label for="company_name" class="control-label col-sm-4">E-mail </label>
								<div class="col-md-5">
								<input type="email" class="form-control" id="company_name" name="company_name" required="required">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="occupation" class="control-label col-sm-4">Occupation </label>
								<div class="col-md-5">
							...
							<div class="form-group">        
								<div class="col-sm-offset-7 col-sm-5">
									<button type="submit" name="submit" class="btn btn-info">Add Employee</button>
									<button type="submit" class="btn btn-danger"><a href="company_control.php">Cancel</a></button>
								</div>
							</div>
						</form>
                    </div>
