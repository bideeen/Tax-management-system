...
<head>
	...
	<title>E-Tax | <?php echo htmlspecialchars($_SESSION["username"]); ?> - Dashboard</title>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong>Tax Payment Histroy</strong>
                    </div>
                    <div class="panel-body">
                        ...
                        <thead>
								...
								<th><strong>Date Payed</strong></th>
								</tr>	
							</thead>
                            <tbody>
                            <?php
									...
									$count=1;
									$sel_query="SELECT * FROM payment WHERE (`username` LIKE '%".$username."%');";
                                    ...
                                    <td align="center"><?php echo $row["date_payed"]; ?></td>  
									</tr>
								<?php $count++; } ?>
                            </tbody>
                        </table>
